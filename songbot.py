#    Copyright (c) 2021 OxyNotOp @FallenAngel_xD
...
@Songbot.on_message(filters.private & ~filters.bot & ~filters.command("help") & ~filters.command("start") & ~filters.command("s"))
async def song(client, message):
 #OxyNotOp #SongBot
    ...
    time.time()
    if song:
        await rkp.edit("Uploading...") #OxyNotOp
        lol = "./thumb.jpg"
...
@Songbot.on_message(filters.command("song") & ~filters.edited & filters.group)
async def song(client, message):
    cap = "@song_op_bot"
...
@Songbot.on_message(filters.command("start"))
...
@Songbot.on_message(filters.command("help"))
...
@Songbot.on_callback_query()
async def button(Songbot, update):
      cb_data = update.data
      if "help" in cb_data:
        await update.message.delete()
        await help(Songbot, update.message)
